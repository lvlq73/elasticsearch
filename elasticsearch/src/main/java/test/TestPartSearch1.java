...
public class TestPartSearch1 {

	private static String host="192.168.2.100"; // 服务器地址
	private static String host1="192.168.2.105"; // 服务器地址
	...
	public void testIndex()throws Exception{
		...
		for(int i=0;i<jsonArray.size();i++){
			...
			IndexResponse response=client.prepareIndex("film3", "dongzuo")
	...
	public void init(){
		//构建一个Index（索引）
		CreateIndexRequest request = new CreateIndexRequest("film3");
	...
	public void initMapping(){
		PutMappingRequest mapping = Requests.putMappingRequest("film3").type("dongzuo").source(getMapping());
	...
	public void search()throws Exception{
		SearchRequestBuilder srb=client.prepareSearch("film3").setTypes("dongzuo");
	...
	public void search2()throws Exception{
		...
		for(SearchHit hit:hits){
			...
			Set<String> names =  hit.getHighlightFields().keySet();
